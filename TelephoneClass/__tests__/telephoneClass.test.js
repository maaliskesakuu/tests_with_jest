...
const PhoneRegister = require('../telephoneClass');
const phones = require('../telephones.json');
...
describe('test getNumbersByType', () => {
	...
	describe('these tests return an array of phone numbers', () => {
		test('home numbers of Leila Hökki returns ["12345678"]', () => {
			expect(
...
describe('Test getAllNumbersByType', () => {
	...
	test('get all numbers of type home', () => {
		...
		expect(phoneRegister.getAllNumbersByType('home')).toEqual(
			expectedResult
		);
	});
	...
	test('get all numbers of type work', () => {
		...
		expect(phoneRegister.getAllNumbersByType('work')).toEqual(
			expectedResult
		);
	});
...
describe('test getName', () => {
	...
	test('get the name of number "12345678" will return {"firstname": "Leila", "lastname": "Hökki"}', () => {
